    ...
    <div class="container">
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="row g-2 mb-3">
                <div class="col-md-5">
                    <input type="email" id="loginEmail" class="form-control" value="admin@bytez.com"
                        placeholder="Email">
                </div>
                <div class="col-md-5">
                    <input type="password" id="loginPassword" class="form-control" value="password"
                ...
                <div class="col-md-7">
                    <select id="endpointSelect" class="form-select">
                        <optgroup label="Clients">
                            <option value="/bytez-erp/api/clients">GET /api/clients</option>
                            <option value="/bytez-erp/api/clients/1">GET /api/clients/1</option>
                        </optgroup>
                        <optgroup label="Projects">
                            <option value="/bytez-erp/api/projects">GET /api/projects</option>
                            <option value="/bytez-erp/api/projects/1">GET /api/projects/1</option>
                        </optgroup>
                        <optgroup label="Tasks">
                            <option value="/bytez-erp/api/tasks">GET /api/tasks</option>
                            <option value="/bytez-erp/api/tasks/1">GET /api/tasks/1</option>
                        </optgroup>
                    </select>
                </div>
                <div class="col-md-3">
