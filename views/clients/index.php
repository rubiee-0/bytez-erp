<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/bytez-erp/clients/create" class="btn btn-primary btn-sm">
            ...
            <table class="table table-hover mb-0" id="clientTable">
                ...
                <tbody>
                    ...
                    <?php if (empty($clients)): ?>
                        <tr>
                            <td colspan="9" class="text-center text-muted py-4">No clients yet. <a
                                    href="/bytez-erp/clients/create">Add one!</a></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
