...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            <a href="/bytez-erp/dashboard/index"
                class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/dashboard') !== false ? 'active' : '' ?>">
                <i class="fas fa-th-large"></i> Dashboard
            </a>
            <a href="/bytez-erp/clients/index"
                class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/clients') !== false ? 'active' : '' ?>">
                <i class="fas fa-building"></i> Clients
            </a>
            <a href="/bytez-erp/projects/index"
                class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/projects') !== false ? 'active' : '' ?>">
                <i class="fas fa-diagram-project"></i> Projects
            </a>
            <a href="/bytez-erp/tasks/index"
                class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/tasks') !== false ? 'active' : '' ?>">
                <i class="fas fa-check-square"></i> Tasks
            </a>
            <a href="/bytez-erp/ai/index"
                class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/ai') !== false ? 'active' : '' ?>">
                <i class="fas fa-robot"></i> AI Tools
            </a>
            <?php if ($user['role'] === 'admin'): ?>
                <a href="/bytez-erp/users/index"
            ...
            <a href="/bytez-erp/auth/logout" class="nav-link" style="color:#f87171;">
