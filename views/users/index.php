<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/bytez-erp/users/create" class="btn btn-primary btn-sm">
                ...
                <tbody>
                    <?php foreach ($users as $i => $u): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/bytez-erp/users/edit/<?= $u['id'] ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <?php if ($u['id'] != $_SESSION['user_id']): ?>
                                    <a href="/bytez-erp/users/delete/<?= $u['id'] ?>" class="btn btn-sm btn-outline-danger"
