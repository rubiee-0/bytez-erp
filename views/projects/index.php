<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/bytez-erp/projects/create" class="btn btn-primary btn-sm">
...
<div class="col-md-4 project-card" data-status="<?= $p['status'] ?>">
    <div class="card h-100">
            ...
            <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="/bytez-erp/projects/view/<?= $p['id'] ?>"><i class="fas fa-eye me-2"></i>View</a></li>
                        <li><a class="dropdown-item" href="/bytez-erp/projects/edit/<?= $p['id'] ?>"><i class="fas fa-edit me-2"></i>Edit</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="/bytez-erp/projects/delete/<?= $p['id'] ?>"
        ...
        <div class="card-footer bg-transparent">
            <a href="/bytez-erp/projects/view/<?= $p['id'] ?>" class="btn btn-sm btn-outline-primary w-100">
                View Details
            </a>
        </div>
    </div>
...
<div class="col-12">
    <div class="text-center py-5 text-muted">
        ...
        <p>No projects yet. <a href="/bytez-erp/projects/create">Create one!</a></p>
    </div>
</div>
<?php endif; ?>
</div>
