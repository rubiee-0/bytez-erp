        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="row g-2" id="contentTypes">
                    <div class="col-md-4">
                        <div class="content-type-btn active border rounded p-3 text-center" data-type="social_media"
                    ...
                    <div class="col-md-4">
                        <div class="content-type-btn border rounded p-3 text-center" data-type="blog_idea"
                            style="cursor:pointer;">
                    ...
                    <div class="col-md-4">
                        <div class="content-type-btn border rounded p-3 text-center" data-type="ad_copy"
                            style="cursor:pointer;">
                    ...
                    <div class="col-md-4">
                        <div class="content-type-btn border rounded p-3 text-center" data-type="email"
                            style="cursor:pointer;">
                    ...
                    <div class="col-md-4">
                        <div class="content-type-btn border rounded p-3 text-center" data-type="seo"
                            style="cursor:pointer;">
    ...
    <div class="col-md-5">
        ...
        <div class="card p-4 mb-4">
            ...
            <div id="insightsResult" class="bg-light rounded p-3"
                style="display:none;white-space:pre-wrap;font-size:0.85rem;line-height:1.6;max-height:400px;overflow-y:auto;">
            </div>
        </div>
...
<script>
    ...
    $('#generateBtn').on('click', function () {
        ...
        $.post('/bytez-erp/ai/generate', { input: input, content_type: type })
            .done(function (res) {
                if (res.success) {
