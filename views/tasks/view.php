<div class="row g-4">
    <div class="col-md-8">
        ...
        <div class="card p-4 mb-4">
            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="/bytez-erp/tasks/edit/<?= $task['id'] ?>" class="btn btn-sm btn-outline-primary">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="/bytez-erp/tasks/delete/<?= $task['id'] ?>" class="btn btn-sm btn-outline-danger"
        ...
        <div class="card p-4 mb-4">
            ...
            <?php foreach ($comments as $c): ?>
                <div class="d-flex gap-3 mb-3">
                    <div
                        style="width:36px;height:36px;min-width:36px;background:#4f46e5;border-radius:50%;
            ...
            <!-- Add Comment -->
            <form method="POST" action="/bytez-erp/tasks/comment/<?= $task['id'] ?>" class="mt-3">
                <div class="d-flex gap-2">
        ...
        <div class="card p-4">
            ...
            <!-- Upload -->
            <form method="POST" action="/bytez-erp/tasks/upload/<?= $task['id'] ?>" enctype="multipart/form-data"
                class="mt-3">
                <div class="d-flex gap-2">
    ...
    <div class="col-md-4">
        <div class="card p-4">
            ...
            <?php foreach (['todo' => ['secondary', 'To Do'], 'in_progress' => ['primary', 'In Progress'], 'completed' => ['success', 'Completed']] as $s => [$color, $label]): ?>
                <a href="/bytez-erp/tasks/edit/<?= $task['id'] ?>"
