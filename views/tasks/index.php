<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/bytez-erp/tasks/create" class="btn btn-primary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body p-2" id="todo-col">
                <?php foreach ($tasks as $t):
                    if ($t['status'] !== 'todo')
                        continue; ?>
                    <div class="task-card border rounded p-3 mb-2 bg-white" data-status="<?= $t['status'] ?>"
                        data-priority="<?= $t['priority'] ?>" data-title="<?= strtolower($t['title']) ?>">
                        <?php
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="/bytez-erp/tasks/view/<?= $t['id'] ?>"
                                    class="btn btn-xs btn-outline-primary btn-sm py-0 px-1">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="/bytez-erp/tasks/edit/<?= $t['id'] ?>"
